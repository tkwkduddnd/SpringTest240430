...
<%-- <c:set value="${bdto.bvo }" var="bvo" ></c:set> --%>
	<form action="/board/modify" method="post" >
			...
			<div class="mb-3">
			  ...
			  <input type="text" class="form-control" name="reg_date" id="e" value="${bvo.regDate }"  placeholder="title">
			</div>
			...
			<div class="mb-3">
			  ...
			  <input type="text" class="form-control" name="reg_date" id="u" value="${bvo.readCount }" readonly="readonly">
			</div>
