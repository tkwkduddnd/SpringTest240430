...
// 정규표현ㅅㄱ을 사용하여 파일의 형식을 제한
// 실행 파일 막기(exe, bat, sh, mis, dll, jar)
// 파일 사이즐 체크(20M 사이즈보다 크면 막기)
...
document.addEventListener('change', (e)=>{
    ...
    if(e.target.id === 'file'){
        ...
        // 각각의 파일은 fileValidation 에 의해 리턴 여부를 체크
...
// <ul class="list-group">
//   <li class="list-group-item"><div>업로드 가능</div>파일 이름</li>
//      <span class="badge text-bg-success">Success</span>
//   <li class="list-group-item"><div>업로드 불가능</div>파일 이름</li>
